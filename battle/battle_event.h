#ifndef __BATTLE_EVENT_H
#define __BATTLE_EVENT_H

#include "swantypes.h"

STRUCT_DECLARE(BattleEventItem)
STRUCT_DECLARE(BattleEventItemStack)
STRUCT_DECLARE(BattleEventHandlerTable)

ENUM_DECLARE(BattleEventVar)
ENUM_DECLARE(BattleEventType)
...
void BattleEvent_InitSystem();
void BattleEvent_StartTurn();
BattleEventItem *BattleEvent_AddItem(BattleEventItemType EventType, __int16 SubID, BattleEventPriority MainPriority, int SubPriority, int DependID, const BattleEventHandlerTable *HandlerTable, unsigned __int16 NumHandlers);
void BattleEvent_RemoveIsolatedItems();
void BattleEvent_ForceCallHandlers(ServerFlow *a1, BattleEventType a2);
void BattleEvent_CallHandlers(ServerFlow *a1, BattleEventType a2);
BattleEventItem *BattleEvent_SeekItem(BattleEventItemType a1, int a2);
BattleEventItem *BattleEvent_GetNextItem(BattleEventItem *a1);
void BattleEvent_PauseMagicCoatItem(int a1);
void BattleEvent_UnpauseMagicCoatItem(int result);
void BattleEvent_PauseEventItemProcessing(int result, BattleEventItemType a2);
int BattleEvent_UnpauseEventItemProcessing(int a1, int a2);
BattleEventItem *BattleEvent_PushItem();
void BattleEvent_PopItem(BattleEventItem *a1);
void BattleEvent_ClearItem(BattleEventItem *a1);

void BattleEventVar_CallHandlersTargetType(ServerFlow *a1, BattleEventType a2, BattleEventItemType a3);
void BattleEventVar_CallHandlersSub(ServerFlow *a1, BattleEventType a2, BattleEventItemType a3, int a4);
void BattleEventVar_CallHandlersCore(ServerFlow *a1, BattleEventType a2, BattleEventItemType a3, int a4);
int BattleEventVar_SkipCheckHandler(ServerFlow *a1, BattleEventItem *a2, BattleEventType a3);
void BattleEventVar_InitStack();
void BattleEventVar_ClearStack();
void BattleEventVar_Push();
void BattleEventVar_Pop();
u32 BattleEventVar_SetValue(BattleEventVar a1, int a2);
u32 BattleEventVar_SetConstValue(BattleEventVar a1, int a2);
u32 BattleEventVar_SetRewriteOnceValue(BattleEventVar a1, int a2);
unsigned int BattleEventVar_SetMulValue(BattleEventVar a1, int value, int mulMin, int mulMax);
...
int BattleEventVar_GetValueIfExist(BattleEventVar a1, int *a2);
u32 BattleEventVar_GetIndexForNewItem(BattleEventItemStack *a1, int a2);
u32 BattleEventVar_GetItemIndex(BattleEventItemStack *a1, int a2);
int BattleEventVar_MulValueRound(BattleEventItemStack *a1, int a2, int a3);

void BattleEventItem_Remove(BattleEventItem *a1);
void BattleEventItem_ConvertToIsolated(BattleEventItem *result);
bool BattleEventItem_IsIsolated(BattleEventItem *a1);
int BattleEventItem_GetSubID(BattleEventItem *a1);
int BattleEventItem_GetPokeID(BattleEventItem *a1);
int BattleEventItem_GetWorkValue(BattleEventItem *a1, int a2);
void BattleEventItem_SetTempItemFlag(BattleEventItem *result);
void BattleEventItem_SetRecallEnable(BattleEventItem *result);
void BattleEventItem_SetWorkValue(BattleEventItem *a1, int a2, int a3);
void BattleEventItem_AttachSkipCheckHandler(BattleEventItem *result, BattleEventSkipCheckHandler a2);
void BattleEventItem_DetachSkipCheckHandler(BattleEventItem *result);
...
struct BattleEventItem
{
  ...
  BattleEventHandlerTable *handlerTable;
  BattleEventSkipCheckHandler skipCheckHandler;
  BattleEventItemType eventItemType;
  int priority;
  int flags;
  int work[7];
  u16 subID;
...
struct BattleEventItemStack
{
  u32 stack_pointer;
  u16 var_type[96];
  u32 var_value[96];
  u32 mul_max_limit[96];
  u32 mul_min_limit[96];
  u8 rewrite_type[96];
};

struct BattleEventHandlerTable
{
